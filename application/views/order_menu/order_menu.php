...
<div id="order-menu-navbar" class="row h-auto">
	<div class="col-12 h-100 p-0">
		<div class="row no-gutters h-100">
			...
			<div class="col h-100">
				<a href="#" onclick="load_last_page()" class="btn bg-dark-red text-light w-100 h-100 rounded-0 center-content">Back</a>
			</div>
		</div>
	</div>
</div>
	...
	<div class="col-12 p-0 h-100">
		...
		<div class="h-75">
			<a href="#" onclick="edit_order_menu(<?= $current_order ?>)"
			   class="btn btn-primary rounded-0 center-content w-100 h-100">Edytuj</a>
		</div>
	</div>
</div>
